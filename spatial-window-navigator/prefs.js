...
class NavigatorSettingsGroup extends Adw.PreferencesGroup {
    static {
        GObject.registerClass(this);
    }
...
export default class SpatialWindowNavigatorPrefs extends ExtensionPreferences {
    getPreferencesWidget() {
        return new NavigatorSettingsGroup(this.getSettings());
    }
}
